...
async function main() {
        ...
        const lowerLayerAddress0 = "http://localhost:8081/coppeliasim_virtualrobot_ur3_robot_0";   
        let initialKnownAgents0 = {
            "coppeliasim_sensor_agent": "http://localhost:8084/coppeliasim_sensor_agent", 
            "coppeliasim_robot_agent_1": "http://localhost:8086/coppeliasim_robot_agent_1"
        };       
